import { z } from 'zod';
import { TASK_PRIORITIES, TASK_RECURRENCE_END_TYPES, TASK_RECURRENCE_FREQUENCIES, TASK_STATUSES, } from '../domain/types.js';
...
export const createTaskSchema = z.intersection(z.object({ householdId: documentIdSchema, clientRequestId: documentIdSchema.optional() }), taskCoreInputSchema);
